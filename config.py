...
import numpy as np
from datatypes import CALL, CHECK, FOLD, INT_POSITIONS_BY_NUM_PLAYERS, PREFLOP_ORDER_BY_NUM_PLAYERS, POSITION_TO_SEAT, PLAYERS_POSITIONS_DICT, BetLimits, Street
from utils import return_deck

class Config:
    def __init__(self, game_type='OmahaHI', num_players=6, bet_limit=BetLimits.POT_LIMIT,
